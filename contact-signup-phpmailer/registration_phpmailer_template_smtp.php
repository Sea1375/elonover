...
try {
    ...
    $mail->setFrom('hello@elonover.io', 'Message from Register');                   // Email Address and Name FROM
    $mail->addAddress('hello@elonover.io', 'Signup');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo($_POST['email_address'], $_POST['full_name']);             // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Register success';                                     // Email Subject
